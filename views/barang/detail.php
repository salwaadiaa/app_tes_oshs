				...
				<div class="row justify-content-center">
                        <div class="col-sm-6">
							...
							<div class="card-header">
								<h6 class="m-0 font-weight-bold text-primary">Detail Barang - <?= $barang->nama_brand ?></h6>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
										<img src="<?= base_url('uploads/' . $barang->gambar) ?>" alt="<?= $barang->nama_brand ?>" class="img-thumbnail mb-4">
									</div>
									<div class="col-md-6">
										<table class="table table-borderless">
											<tr>
												<td>Nama Brand</td>
												<td>:</td>
												<td><b><?= $barang->nama_brand ?></b></td>
											</tr>
											<tr>
												<td>Kategori</td>
												<td>:</td>
												<td><b><?= $barang->kategori ?></b></td>
											</tr>
											<tr>
												<td>Merk</td>
												<td>:</td>
												<td><b><?= $barang->merk ?></b></td>
											</tr>
										</table>
									</div>
								</div>
								<div class="row">
									<div class="col">
										...
										<a href="<?= base_url('barang') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
									</div>
								</div>
							</div>
						</div>
