				...
				<div class="row justify-content-center">
                    <div class="col-sm-6">
                        <div class="card shadow mx-auto">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('kategori/proses_ubah/' . $kategori->id) ?>">
								  	<div class="form-group">
										<label for="kategori">Nama Katgori</label>
										<input type="text" class="form-control" name="kategori" id="kategori" autocomplete="off" required="required" placeholder="Masukan katgori disini" value="<?= $kategori->kategori ?>">
								  	</div>
								  	<div class="form-group">
										<button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
										<button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</button>
										<a href="<?= base_url('kategori') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
								  	</div>
								</form>
							</div>
						</div>
