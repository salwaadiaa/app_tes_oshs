							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('akun/tambah') ?>" enctype="multipart/form-data">
								  	<div class="form-group">
								  		...
								  		<input type="text" name="nama" id="nama" required="required" placeholder="Masukan Nama " autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
								  		<label for="email">email</label>
								  		<input type="text" name="email" id="email" required="required" placeholder="Masukan Email" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
								  		<label for="password">Password</label>
								  		<input type="password" name="password" id="password" required="required" placeholder="Masukan Password" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
								  		<label for="password2">Konfirmasi Password</label>
								  		<input type="password" name="password2" id="password2" required="required" placeholder="Ketik Ulang Password" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
