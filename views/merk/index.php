							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('merk/tambah') ?>">
								  	<div class="form-group">
										...
										<input type="text" class="form-control" name="merk" id="merk" autocomplete="off" required="required" placeholder="Masukan nama merk">
								  	</div>
								  	<div class="form-group">
	                 					...
	                 					<?php while($merk = $data_merk->fetch_object()) : ?>
	                 						<tr>
	                 							...
	                 							<td>
	                 								...
	                 								<a href="#" class="btn btn-sm btn-danger" onclick="confirmDelete('<?= base_url('merk/hapus/' . $merk->id) ?>')"><i class="fa fa-trash"></i> Hapus</a>
	                 							</td>
	                 						</tr>
	                 					<?php endwhile; ?>
	                 				</tbody>
